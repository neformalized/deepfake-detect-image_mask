...
class Handler():
    ...
    def __init__(self, dataset_train_path, dataset_validation_path, buffer_size, input_image, output_labels, metric_target, save_path):
        ...
        self.encoder_input = image.Encoder(self.input_image)
        ...
        self.buffer = buffer.Dual(self.buffer_size, self.input_image, self.output_labels)
    #
